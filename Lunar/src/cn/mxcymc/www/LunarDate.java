...
public class LunarDate {
	...
	public static String getYear(int y, int m, int d) {
                Calendar today = Calendar.getInstance();
		today.set(y, m-1, d);
		LunarDate lunar = new LunarDate(today);
		return lunar.cyclical() + lunar.animalsYear() + "年";
	}
	...
	public String toString() {
            if (chineseNumber[month - 1].equals("一")) {
                if (getChinaDayString(day).equals("初一"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初二"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初三"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初四"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初五"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初六"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初七"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初八"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初九"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("初十"))
                    return (leap ? "闰正月" : "大年") + getChinaDayString(day);
                else
                    return (leap ? "闰" : "") + "正月" + getChinaDayString(day);
                }
            if (chineseNumber[month - 1].equals("腊")) {
                if (getChinaDayString(day).equals("廿三"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿四"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿五"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿六"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿七"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿八"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("廿九"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                if (getChinaDayString(day).equals("三十"))
                    return (leap ? "闰腊月" : "大年") + getChinaDayString(day);
                else
                    return (leap ? "闰" : "") + "腊月" + getChinaDayString(day);
                }
		...
		today.set(y, m-1, d);
		LunarDate lunar = new LunarDate(today);
                return String.valueOf(lunar);
	}
        public static String getLunarPlus(int y, int m, int d) {
                Calendar today = Calendar.getInstance();
		today.set(y, m-1, d);
        ...
        public static String getTodayLunarPlus() {
                Calendar today = Calendar.getInstance();
		today.setTime(new Date());
                today.add(Calendar.DAY_OF_MONTH, 1);
		LunarDate lunar = new LunarDate(today);
		...
		return getTodayYear()+" "+ getTodayLunar();
	}
}
